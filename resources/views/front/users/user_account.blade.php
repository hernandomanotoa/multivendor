        ...
        <div class="container">
            <div class="page-intro">
                ...
                <ul class="bread-crumb">
                    ...
                    <li class="is-marked">
                        <a href="account.html">{{ __('Account') }}</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="login-wrapper">
                        <h2 class="account-h2 u-s-m-b-20" style="font-size: 18px">{{ __('Update Contact Details') }}</h2>
                        ...
                        <form id="accountForm" action="javascript:;" method="post"> {{-- We need to deactivate the 'action' HTML attribute (using    'javascript:;'    ) as we'r going to submit using an AJAX call. Check front/js/custom.js --}}
                            ...
                            <div class="u-s-m-b-30">
                                <label for="user-address">{{ __('Address') }}
                                    <span class="astk">*</span>
                                </label>
                            ...
                            <div class="u-s-m-b-30">
                                <label for="user-country">{{ __('Country') }}
                                    <span class="astk">*</span>
                                </label>
                            ...
                            <div class="u-s-m-b-30">
                                <label for="user-pincode">{{ __('Pincode') }}
                                    <span class="astk">*</span>
                                </label>
                            ...
                            <div class="u-s-m-b-30">
                                <label for="user-mobile">{{ __('Mobile') }}
                                    <span class="astk">*</span>
                                </label>
                            ...
                            <div class="m-b-45">
                                <button class="button button-outline-secondary w-100">{{ __('Update') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="reg-wrapper">
                        <h2 class="account-h2 u-s-m-b-20" style="font-size: 18px">{{ __('Update Password') }}</h2>
                        ...
                        <form id="passwordForm" action="javascript:;" method="post"> {{-- We need to deactivate the 'action' HTML attribute (using    'javascript:;'    ) as we'r going to submit using an AJAX call. Check front/js/custom.js --}}
                            ...
                            <div class="u-s-m-b-30">
                                <label for="current-password">{{ __('Current Password') }}
                                    <span class="astk">*</span>
                                </label>
                                <input type="password" id="current-password" class="text-field" placeholder="{{ __('Current Password') }}" name="current_password">
                            ...
                            <div class="u-s-m-b-30">
                                <label for="usermobile">{{ __('New Password') }}
                                    <span class="astk">*</span>
                                </label>
                                <input type="password" id="new-password" class="text-field" placeholder="{{ __('New Password') }}" name="new_password">
                            ...
                            <div class="u-s-m-b-30">
                                <label for="useremail">{{ __('Confirm Password') }}
                                    <span class="astk">*</span>
                                </label>
                                <input type="password" id="confirm-password" class="text-field" placeholder="{{ __('Confirm Password') }}" name="confirm_password">
                            ...
                            <div class="u-s-m-b-45">
                                <button class="button button-primary w-100">{{ __('Update') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
