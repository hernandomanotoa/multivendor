{{-- This page is 'include'-ed in front/products/checkout.blade.php, and will be used by jQuery AJAX to reload it, check front/js/custom.js --}}
    ...
    <!-- Form-Fields /- -->
    <h4 class="section-h4 deliveryText">{{ __('Add New Delivery Address') }}</h4> {{-- We created that deliveryText CSS class to use the HTML element as a handle for jQuery to change the <h4> content when clicking the Edit button --}}
    <div class="u-s-m-b-24">
        ...
        @if (count($deliveryAddresses) > 0) {{-- Checking if there are any $deliveryAddreses for the currently authenticated/logged-in user --}} {{-- $deliveryAddresses variable is passed in from checkout() method in Front/ProductsController.php --}}
            <label class="label-text newAddress" for="ship-to-different-address">{{ __('Ship to a different address?') }}</label>
        @else {{-- if there're no already existing delivery addresses --}}
            <label class="label-text newAddress" for="ship-to-different-address">{{ __('Check to add Delivery Address') }}</label>
        @endif
        ...
        <form id="addressAddEditForm" action="javascript:;" method="post">
            ...
            <div class="group-inline u-s-m-b-13">
                <div class="group-1 u-s-p-r-16">
                    <label for="delivery_name">{{ __('Name') }}
                ...
                <div class="group-2">
                    <label for="delivery_address">{{ __('Address') }}
                        <span class="astk">*</span>
                    </label>
            ...
            <div class="group-inline u-s-m-b-13">
                <div class="group-1 u-s-p-r-16">
                    <label for="delivery_city">{{ __('City') }}
                        <span class="astk">*</span>
                    </label>
                ...
                <div class="group-2">
                    <label for="delivery_state">{{ __('State') }}
                        <span class="astk">*</span>
                    </label>
            ...
            <div class="u-s-m-b-13">
                <label for="select-country-extra">{{ __('Country') }}
                    <span class="astk">*</span>
                </label>
            ...
            <div class="u-s-m-b-13">
                <label for="delivery_pincode">{{ __('Pincode') }}
                    <span class="astk">*</span>
                </label>
            ...
            <div class="u-s-m-b-13">
                <label for="delivery_mobile">{{ __('Mobile') }}
                    <span class="astk">*</span>
                </label>
            ...
            <div class="u-s-m-b-13">
                <button style="width: 100%" type="submit" class="button button-outline-secondary">{{ __('Save') }}</button> {{-- Save whether it's Add or Edit --}} 
            </div>
