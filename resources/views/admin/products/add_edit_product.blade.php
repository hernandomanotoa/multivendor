                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample"
                                    ...
                                    <select name="brand_id" id="brand_id" class="form-control text-dark">
                                        ...
                                        @foreach ($brands as $brand)
                                            <option value="{{ $brand['id'] }}"
                                                @if (!empty($product['brand_id'] == $brand['id'])) selected @endif>{{ $brand['name'] }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="product_image">{{ __('Product Image (Recommended Size: 1000x1000)') }}</label>
                                ...
                                <div class="form-group">
                                    <label for="product_video">{{ __('Product Video (Recommended Size: Less than 2 MB)') }}</label>
                                ...
                                <div class="form-group">
                                    <label for="is_featured">{{ __('Featured Item (Yes/No)') }}</label>
                                    <input type="checkbox" name="is_featured" id="is_featured" value="Yes"
                                        @if (!empty($product['is_featured']) && $product['is_featured'] == 'Yes') checked @endif>
                                </div>
                                <div class="form-group">
                                    <label for="is_bestseller">{{ __('Best Seller Item (Yes/No)') }}</label> {{-- Note: Only 'superadmin' can mark a product as 'bestseller', but 'vendor' can't --}}
