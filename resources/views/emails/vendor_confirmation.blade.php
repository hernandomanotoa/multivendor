...
<html>
    ...
    <body>
        ...
        <tr><td><a href="{{ secure_url('vendor/confirm/' . $code) }}">{{ secure_url('vendor/confirm/' . $code) }}</a></td></tr> {{-- Check the route in web.php --}} {{-- $code is the base64 encoded vendor `email` which will be sent to the route and will be decoded by confirmVendor() method in Front/VendorController.php --}}
        <tr><td>&nbsp;<br></td></tr>
